...
type Props = {
  ...
  tickColor: string
  isDark: boolean
  highlightedMonths?: string[] // SIVA FIX: Wajib ditambahkan agar grafik bisa menerima perintah highlight dari page.tsx
}

const CustomerBarChart = memo(function CustomerBarChart({
  data,
  gridColor,
  tickColor,
  isDark,
  ...
  // SIVA FIX: Warna dim dibuat lebih pudar agar highlight bulan sangat terlihat (seperti di CSAT)
  const dimColor = isDark ? "rgba(14,165,233,0.15)" : "rgba(14,165,233,0.25)"
